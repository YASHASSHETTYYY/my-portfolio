    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-50 to-purple-50">
      ...
      <section className="h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-indigo-900 animate-fade-in">
            Data Analyst & AI Specialist
          </h1>
          <p className="text-xl md:text-2xl text-indigo-700 max-w-2xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
